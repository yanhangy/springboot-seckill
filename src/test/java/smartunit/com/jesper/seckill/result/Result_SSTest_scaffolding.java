...
public class Result_SSTest_scaffolding {
  ...
  public static void initSmartSuiteFramework() { 
    org.smartunit.runtime.RuntimeSettings.className = "com.jesper.seckill.result.Result"; 
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.jesper.seckill.result.CodeMsg", false, Result_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
  }
