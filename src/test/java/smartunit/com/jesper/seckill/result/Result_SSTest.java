...
public class Result_SSTest extends Result_SSTest_scaffolding {
  ...
  public void test_setMsg_0()  throws Throwable  {
      Result<Object> result0 = Result.success((Object) "Session\u4E0D\u5B58\u5728\u6216\u8005\u5DF2\u7ECF\u5931\u6548");
  ...
  public void test_setData_1()  throws Throwable  {
      ...
      doReturn("500212").when(codeMsg0).getMsg();
      ...
      //invoke method for result0
      assertEquals("500212", result0.getMsg());
  }
  @Test(timeout = 4000)
  ...
  @Test(timeout = 4000)
  public void test_error_3()  throws Throwable  {
      ...
      doReturn("x_,").when(codeMsg0).getMsg();
  ...
  public void test_getCode_5()  throws Throwable  {
      ...
      CodeMsg codeMsg0 = mock(CodeMsg.class, withSettings().defaultAnswer(new ViolatedAssumptionAnswer()).stubOnly());
      doReturn((-1)).when(codeMsg0).getCode();
      doReturn("com.jesper.seckill.result.CodeMsg").when(codeMsg0).getMsg();
