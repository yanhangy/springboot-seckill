...
public class SeckillGoods_SSTest extends SeckillGoods_SSTest_scaffolding {
  ...
  @Test(timeout = 4000)
  public void test_setStartDate_2()  throws Throwable  {
      SeckillGoods seckillGoods0 = new SeckillGoods();
      Date date0 = mock(Date.class, withSettings().defaultAnswer(new ViolatedAssumptionAnswer()).stubOnly());
  ...
  @Test(timeout = 4000)
  public void test_setVersion_4()  throws Throwable  {
      SeckillGoods seckillGoods0 = new SeckillGoods();
  ...
  @Test(timeout = 4000)
  public void test_setStockCount_5()  throws Throwable  {
      SeckillGoods seckillGoods0 = new SeckillGoods();
  ...
  @Test(timeout = 4000)
  public void test_getVersion_9()  throws Throwable  {
      SeckillGoods seckillGoods0 = new SeckillGoods();
