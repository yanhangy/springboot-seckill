...
public class RedisPoolFactory_SSTest extends RedisPoolFactory_SSTest_scaffolding {
  ...
  public void test_JedisPoolFactory_0()  throws Throwable  {
      ...
      doReturn(138).when(redisConfig0).getPoolMaxIdle();
      doReturn((-719)).when(redisConfig0).getPoolMaxTotal();
      doReturn(7).when(redisConfig0).getPoolMaxWait();
      doReturn(1).when(redisConfig0).getPort();
      doReturn(951).when(redisConfig0).getTimeout();
