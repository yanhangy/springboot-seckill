...
public class RedisPoolFactory_SSTest extends RedisPoolFactory_SSTest_scaffolding {
  ...
  public void test_JedisPoolFactory_0()  throws Throwable  {
      //caseID:d41bfbc962daf97e03f6ab86db66b324
      ...
      doReturn("com.jesper.seckill.redis.RedisPoolFactory").when(redisConfig0).getHost();
      doReturn("tkG6>kshsjn@hxT5W").when(redisConfig0).getPassword();
      doReturn(1000).when(redisConfig0).getPoolMaxIdle();
      doReturn((-1)).when(redisConfig0).getPoolMaxTotal();
      doReturn(168).when(redisConfig0).getPoolMaxWait();
      doReturn(1778).when(redisConfig0).getPort();
