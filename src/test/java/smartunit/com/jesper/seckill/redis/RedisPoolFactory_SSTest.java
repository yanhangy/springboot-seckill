...
public class RedisPoolFactory_SSTest extends RedisPoolFactory_SSTest_scaffolding {
  ...
  public void test_JedisPoolFactory_0()  throws Throwable  {
      //caseID:520555f1620fd998797360110ade1bfe
      ...
      doReturn("1.0").when(redisConfig0).getPassword();
      doReturn(1).when(redisConfig0).getPoolMaxIdle();
      doReturn(593).when(redisConfig0).getPoolMaxTotal();
      doReturn(111).when(redisConfig0).getPoolMaxWait();
      doReturn(107).when(redisConfig0).getPort();
