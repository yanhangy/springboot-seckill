...
public class RedisPoolFactory_SSTest extends RedisPoolFactory_SSTest_scaffolding {
  ...
  public void test_JedisPoolFactory_0()  throws Throwable  {
      //caseID:0ef70f32084e20bde91b511c8abc106e
      ...
      doReturn("1").when(redisConfig0).getPassword();
      doReturn((-1)).when(redisConfig0).getPoolMaxIdle();
      doReturn(74).when(redisConfig0).getPoolMaxTotal();
      doReturn(1000).when(redisConfig0).getPoolMaxWait();
      doReturn((-1)).when(redisConfig0).getPort();
      doReturn(4666).when(redisConfig0).getTimeout();
