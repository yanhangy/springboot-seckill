...
public class RedisPoolFactory_SSTest extends RedisPoolFactory_SSTest_scaffolding {
  ...
  public void test_JedisPoolFactory_0()  throws Throwable  {
      //caseID:cff461037ee5d3d4ec5402df92d9c70c
      ...
      doReturn("1.0").when(redisConfig0).getHost();
      doReturn(" /@9xE >U").when(redisConfig0).getPassword();
      ...
      doReturn(1000).when(redisConfig0).getTimeout();
