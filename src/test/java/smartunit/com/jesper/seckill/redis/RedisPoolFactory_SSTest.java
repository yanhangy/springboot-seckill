...
public class RedisPoolFactory_SSTest extends RedisPoolFactory_SSTest_scaffolding {
  ...
  public void test_JedisPoolFactory_0()  throws Throwable  {
      //caseID:514e13d208d149b2eb3553e705bedd6b
      ...
      doReturn("").when(redisConfig0).getHost();
      doReturn("com.jesper.seckill.redis.RedisPoolFactory").when(redisConfig0).getPassword();
      doReturn(0).when(redisConfig0).getPoolMaxIdle();
      doReturn(11).when(redisConfig0).getPoolMaxTotal();
      doReturn((-1)).when(redisConfig0).getPoolMaxWait();
      doReturn(1000).when(redisConfig0).getPort();
      doReturn((-1)).when(redisConfig0).getTimeout();
