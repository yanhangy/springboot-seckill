...
public class RedisPoolFactory_SSTest extends RedisPoolFactory_SSTest_scaffolding {
  ...
  public void test_JedisPoolFactory_0()  throws Throwable  {
      //caseID:67e914a295fe59666d178944e5888681
      ...
      doReturn(10).when(redisConfig0).getPoolMaxTotal();
      doReturn(2284).when(redisConfig0).getPoolMaxWait();
      doReturn(0).when(redisConfig0).getPort();
      doReturn(6).when(redisConfig0).getTimeout();
