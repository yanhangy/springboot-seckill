...
public class RedisPoolFactory_SSTest extends RedisPoolFactory_SSTest_scaffolding {
  ...
  public void test_JedisPoolFactory_0()  throws Throwable  {
      //caseID:4dc994bc06ff08f5cef1d32416703314
      ...
      doReturn("hashCode").when(redisConfig0).getHost();
      doReturn("").when(redisConfig0).getPassword();
      doReturn(316).when(redisConfig0).getPoolMaxIdle();
      doReturn(1000).when(redisConfig0).getPoolMaxTotal();
      doReturn(1).when(redisConfig0).getPoolMaxWait();
      doReturn(1).when(redisConfig0).getPort();
      doReturn(1626).when(redisConfig0).getTimeout();
