...
public class RedisPoolFactory_SSTest extends RedisPoolFactory_SSTest_scaffolding {
  ...
  public void test_JedisPoolFactory_0()  throws Throwable  {
      //caseID:8b646b38c9f39d560fce8ab66e3ae300
      ...
      doReturn("4AD)'Ctu").when(redisConfig0).getHost();
      doReturn("1").when(redisConfig0).getPassword();
      doReturn(1719).when(redisConfig0).getPoolMaxIdle();
      doReturn(1278).when(redisConfig0).getPoolMaxTotal();
      doReturn(0).when(redisConfig0).getPoolMaxWait();
      doReturn(0).when(redisConfig0).getPort();
      doReturn(1214).when(redisConfig0).getTimeout();
