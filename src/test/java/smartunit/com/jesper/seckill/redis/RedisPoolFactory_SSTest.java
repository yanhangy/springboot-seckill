...
public class RedisPoolFactory_SSTest extends RedisPoolFactory_SSTest_scaffolding {
  ...
  public void test_JedisPoolFactory_0()  throws Throwable  {
      //caseID:60c8482477d1684ad691fb5885ead2c3
      ...
      doReturn("6c#DQ@?E8!}P#13").when(redisConfig0).getHost();
      doReturn("1").when(redisConfig0).getPassword();
      doReturn(828).when(redisConfig0).getPoolMaxIdle();
      doReturn(47).when(redisConfig0).getPoolMaxTotal();
