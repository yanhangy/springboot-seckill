...
public class SeckillController_SSTest extends SeckillController_SSTest_scaffolding {
  ...
  public void test_list_0()  throws Throwable  {
      //caseID:648ce5ff846efd918af47dee9749f49e
      ...
      Result<Integer> result0 = seckillController0.list(model0, user0, 410L);
      assertEquals(500104, result0.getCode());
  }
  @Test(timeout = 4000)
  public void test_list_1()  throws Throwable  {
      //caseID:d93ffb640d371dbb25857aa3028122bf
      SeckillController seckillController0 = new SeckillController();
      Model model0 = mock(Model.class, withSettings().defaultAnswer(new ViolatedAssumptionAnswer()).stubOnly());
      Result<Integer> result0 = seckillController0.list(model0, (User) null, 1000L);
      assertEquals(500210, result0.getCode());
  }
  @Test(timeout = 4000)
  public void test_seckillResult_2()  throws Throwable  {
      //caseID:0e5461737744b8c5663d1c6be86ac54d
      SeckillController seckillController0 = new SeckillController();
      ...
      Result<Long> result0 = seckillController0.seckillResult(model1, (User) null, 4727L);
      assertEquals(500210, result0.getCode());
  }
  @Test(timeout = 4000)
  public void test_seckillResult_3()  throws Throwable  {
      //caseID:71b728c077e821f06945b4d0a2ccc2bf
      SeckillController seckillController0 = new SeckillController();
      ...
      Result<Long> result0 = seckillController0.seckillResult(model1, user0, 853L);
      assertEquals(0, result0.getCode());
  }
  @Test(timeout = 4000)
  public void test_list_4()  throws Throwable  {
      //caseID:e00264f247873e3fc7aa63f654c3b4d3
      SeckillController seckillController0 = new SeckillController();
      ...
      doReturn(model0).when(model1).addAttribute(anyString() , any());
      User user0 = mock(User.class, withSettings().defaultAnswer(new ViolatedAssumptionAnswer()).stubOnly());
      Result<Integer> result0 = seckillController0.list(model1, user0, 1718L);
      assertEquals("\u5546\u54C1\u5DF2\u7ECF\u79D2\u6740\u5B8C\u6BD5", result0.getMsg());
  }
  @Test(timeout = 4000)
  public void test_list_5()  throws Throwable  {
      //caseID:bc9dfb05e6645873eda7ab963ff4b466
      SeckillController seckillController0 = new SeckillController();
      ...
      User user0 = mock(User.class, withSettings().defaultAnswer(new ViolatedAssumptionAnswer()).stubOnly());
      doReturn(long0).when(user0).getId();
      Result<Integer> result0 = seckillController0.list(model1, user0, 139L);
      assertEquals(500501, result0.getCode());
  }

  @Test(timeout = 4000)
  public void test_list_6()  throws Throwable  {
      //caseID:d5927123bcb3f059a50c367961d0721b
      SeckillController seckillController0 = new SeckillController();
  ...
  public void test_list_7()  throws Throwable  {
      //caseID:639466808824a957a93a113fe554c38f
      SeckillController seckillController0 = new SeckillController();
