...
public class OrderController_SSTest extends OrderController_SSTest_scaffolding {
  ...
  public void test_info_0()  throws Throwable  {
      //caseID:1f0fc57d5267dc7306b8414a72ee4c78
      ...
      Result<OrderDetailVo> result0 = orderController0.info(model0, (User) null, 410L);
      assertEquals("Session\u4E0D\u5B58\u5728\u6216\u8005\u5DF2\u7ECF\u5931\u6548", result0.getMsg());
  }
  @Test(timeout = 4000)
  public void test_info_1()  throws Throwable  {
      //caseID:2d90f5061e90b72b4af13e69906d0735
      OrderController orderController0 = new OrderController();
