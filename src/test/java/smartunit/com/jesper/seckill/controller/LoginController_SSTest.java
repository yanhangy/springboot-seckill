...
public class LoginController_SSTest extends LoginController_SSTest_scaffolding {
  ...
  public void test_toLogin_0()  throws Throwable  {
      //caseID:23338b291d4ee1b96e2d8409cdc51049
  ...
  public void test_doLogin_1()  throws Throwable  {
      //caseID:7a0470f254d86d05108b2d8c593e4196
      LoginController loginController0 = new LoginController();
      ...
      doReturn("1").when(userService0).login(any(javax.servlet.http.HttpServletResponse.class) , any(com.jesper.seckill.vo.LoginVo.class));
      ...
      doReturn("com.jesper.seckill.controller.LoginController").when(loginVo0).toString();
