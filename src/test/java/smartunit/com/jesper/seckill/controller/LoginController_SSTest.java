...
public class LoginController_SSTest extends LoginController_SSTest_scaffolding {
  ...
  public void test_toLogin_0()  throws Throwable  {
      //caseID:493ec7c2fb687ee2d42d34d41fc32ffc
  ...
  public void test_doLogin_1()  throws Throwable  {
      //caseID:f20118c19fa6e789c50a3bca5c8da5f5
      LoginController loginController0 = new LoginController();
      ...
      doReturn(",$_D&m.I~}?K)feZ").when(userService0).login(any(javax.servlet.http.HttpServletResponse.class) , any(com.jesper.seckill.vo.LoginVo.class));
      ...
      doReturn("149").when(loginVo0).toString();
