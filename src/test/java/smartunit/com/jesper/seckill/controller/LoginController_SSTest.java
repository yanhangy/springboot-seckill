...
public class LoginController_SSTest extends LoginController_SSTest_scaffolding {
  ...
  public void test_doLogin_1()  throws Throwable  {
      ...
      doReturn("1").when(userService0).login(nullable(javax.servlet.http.HttpServletResponse.class) , nullable(com.jesper.seckill.vo.LoginVo.class));
      ...
      doReturn("org.apache.commons.pool2.PooledObjectState").when(loginVo0).toString();
