...
public class LoginController_SSTest extends LoginController_SSTest_scaffolding {
  ...
  public void test_toLogin_0()  throws Throwable  {
      //caseID:b95c16399f7fce3fccbf614a592e6cf5
  ...
  public void test_doLogin_1()  throws Throwable  {
      //caseID:eea41316c7877d3f724d078797fa5306
      LoginController loginController0 = new LoginController();
      ...
      doReturn("yU").when(userService0).login(any(javax.servlet.http.HttpServletResponse.class) , any(com.jesper.seckill.vo.LoginVo.class));
      ...
      doReturn("$.\"tEq`Q$%").when(loginVo0).toString();
