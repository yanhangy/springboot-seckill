...
public class LoginController_SSTest extends LoginController_SSTest_scaffolding {
  ...
  public void test_toLogin_0()  throws Throwable  {
      //caseID:4ec18b5ca45f31df205b03a103e9bc43
  ...
  public void test_doLogin_1()  throws Throwable  {
      //caseID:b3fc529c2eeecfacdb0ba077935a0e48
      LoginController loginController0 = new LoginController();
      ...
      doReturn("XJmuJc rmmq=EPY").when(userService0).login(any(javax.servlet.http.HttpServletResponse.class) , any(com.jesper.seckill.vo.LoginVo.class));
      ...
      doReturn("E").when(loginVo0).toString();
