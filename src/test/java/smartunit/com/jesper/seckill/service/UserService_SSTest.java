...
// allCoveredLines:[23, 34, 38, 39, 41, 42, 44, 45, 46, 49, 50, 51, 52, 53, 56, 57, 58, 66, 67, 68, 69, 70, 71, 77, 78, 80, 82, 83, 85]
  ...
  public void test_getByToken_0()  throws Throwable  {
      //caseID:c2986f0faa9a25b08025b3ae8c8160ca
  ...
  public void test_getByToken_1()  throws Throwable  {
      //caseID:4e3dda2c589220bd2bb7dffec94f3fb0
      ...
      //Call method: getByToken
      User user0 = userService0.getByToken(httpServletResponse0, "28");
  ...
  public void test_getByToken_2()  throws Throwable  {
      //caseID:daedd45768c326c107dfa03b46463853
      //CoveredLines: [23, 66, 67, 68, 69, 70, 71, 77, 80, 82, 83, 85]
      //Input_0_HttpServletResponse: {}
      //Input_1_String: "ycxX:G<12"
      ...
      //Call method: getByToken
      User user1 = userService0.getByToken(httpServletResponse0, "ycxX:G<12");
  ...
  public void test_login_3()  throws Throwable  {
      //caseID:48ad192aed61ca83dc42a2d0b598a364
  ...
  public void test_login_4()  throws Throwable  {
      //caseID:20c1df691d49c28bc359d72e17049c3e
      //CoveredLines: [23, 34, 38, 41, 42, 44, 45, 46]
      //Input_0_HttpServletResponse: {}
      //Input_1_LoginVo: {getPassword="48", getMobile="48"}
      ...
      doReturn("48").when(loginVo0).getMobile();
      doReturn("48").when(loginVo0).getPassword();
  ...
  public void test_login_5()  throws Throwable  {
      //caseID:405b36aaf18e1414184e18785f19354f
      //CoveredLines: [23, 34, 38, 41, 42, 44, 45, 49, 50, 51, 52, 53]
      //Input_0_HttpServletResponse: {}
      //Input_1_LoginVo: {getPassword="-2068419799", getMobile="-2068419799"}
      
      UserService userService0 = new UserService();
      //mock user0
      User user0 = mock(User.class, withSettings().defaultAnswer(new ViolatedAssumptionAnswer()).stubOnly());
      doReturn("-2068419799").when(user0).getPassword();
      doReturn("-2068419799").when(user0).getSalt();
      ...
      //mock loginVo0
      LoginVo loginVo0 = mock(LoginVo.class, withSettings().defaultAnswer(new ViolatedAssumptionAnswer()).stubOnly());
      doReturn("-2068419799").when(loginVo0).getMobile();
      doReturn("-2068419799").when(loginVo0).getPassword();
  ...
  public void test_login_6()  throws Throwable  {
      //caseID:bc0ad1cef803616546faa3be17fcabe8
      //CoveredLines: [23, 34, 38, 41, 42, 44, 45, 49, 50, 51, 52, 56, 57, 58, 66, 67, 68, 69, 70, 71]
      //Input_0_HttpServletResponse: {}
      //Input_1_LoginVo: {getPassword="token", getMobile="-578582866"}
      //Assert: assertEquals("eb853f7bc5ef4e298a9f268e4f9b6d20", method_result);
      ...
      //mock loginVo0
      LoginVo loginVo0 = mock(LoginVo.class, withSettings().defaultAnswer(new ViolatedAssumptionAnswer()).stubOnly());
      doReturn("-578582866").when(loginVo0).getMobile();
      ...
      //  // Unstable assertion: 
      //Test Result Assert
      assertEquals("eb853f7bc5ef4e298a9f268e4f9b6d20", string0);
  }
}
