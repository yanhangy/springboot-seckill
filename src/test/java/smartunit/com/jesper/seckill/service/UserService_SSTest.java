...
// allCoveredLines:[23, 34, 38, 39, 41, 42, 44, 45, 46, 49, 50, 51, 52, 53, 56, 57, 58, 66, 67, 68, 69, 70, 71, 77, 78, 80, 82, 83, 85]
  ...
  public void test_getByToken_0()  throws Throwable  {
      //caseID:ba8366ecb231b760973c510badfbcd54
  ...
  public void test_getByToken_1()  throws Throwable  {
      //caseID:a88a037856257e616c31eeb74dc142a9
      //CoveredLines: [23, 77, 80, 82, 85]
      //Input_0_HttpServletResponse: {}
      //Input_1_String: "org.apache.tomcat.util.buf.Utf8Encoder"
      //Assert: assertNull(method_result);
      ...
      //Call method: getByToken
      User user0 = userService0.getByToken(httpServletResponse0, "org.apache.tomcat.util.buf.Utf8Encoder");
  ...
  public void test_getByToken_2()  throws Throwable  {
      //caseID:1e25aaaac87799f4654e5656a51308da
      //CoveredLines: [23, 66, 67, 68, 69, 70, 71, 77, 80, 82, 83, 85]
      //Input_0_HttpServletResponse: {}
      //Input_1_String: "BITFIELD"
      ...
      //Call method: getByToken
      User user1 = userService0.getByToken(httpServletResponse0, "BITFIELD");
  ...
  public void test_login_3()  throws Throwable  {
      //caseID:f7b30ec499c8208bbbce731528978e20
  ...
  public void test_login_4()  throws Throwable  {
      //caseID:92647f0df7d771df21bcd9afd882320b
  ...
  public void test_login_5()  throws Throwable  {
      //caseID:ade681f87fc79a25c4abb6d7a6a0ca25
      //CoveredLines: [23, 34, 38, 41, 42, 44, 45, 49, 50, 51, 52, 53]
      //Input_0_HttpServletResponse: {}
      //Input_1_LoginVo: {getPassword="-2082408383", getMobile="-2082408383"}
      ...
      doReturn("-2082408383").when(user0).toString();
      //mock userMapper0
      UserMapper userMapper0 = mock(UserMapper.class, withSettings().defaultAnswer(new ViolatedAssumptionAnswer()).stubOnly());
  ...
  public void test_login_6()  throws Throwable  {
      //caseID:a5ac217434651a8c5ac7b3c5a7c483cd
      //CoveredLines: [23, 34, 38, 41, 42, 44, 45, 49, 50, 51, 52, 56, 57, 58, 66, 67, 68, 69, 70, 71]
      //Input_0_HttpServletResponse: {}
      //Input_1_LoginVo: {getPassword="token", getMobile="1"}
      //Assert: assertEquals("4718bf6115c5464696b7e4ce8e0300cd", method_result);
      ...
      doReturn("LTRIM").when(user0).toString();
      //mock userMapper0
      UserMapper userMapper0 = mock(UserMapper.class, withSettings().defaultAnswer(new ViolatedAssumptionAnswer()).stubOnly());
      doReturn(user0).when(userMapper0).getById(anyLong());
      //mock redisService0
      ...
      //  // Unstable assertion: 
      //Test Result Assert
      assertEquals("4718bf6115c5464696b7e4ce8e0300cd", string0);
  }
}
