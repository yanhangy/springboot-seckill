...
public class UserService_SSTest_scaffolding {
  ...
  public static void initSmartSuiteFramework() { 
    org.smartunit.runtime.RuntimeSettings.className = "com.jesper.seckill.service.UserService"; 
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.jesper.seckill.bean.User", false, UserService_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("com.jesper.seckill.mapper.UserMapper", false, UserService_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("com.jesper.seckill.redis.RedisService", false, UserService_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("com.jesper.seckill.vo.LoginVo", false, UserService_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("javax.servlet.http.HttpServletResponse", false, UserService_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
  }
