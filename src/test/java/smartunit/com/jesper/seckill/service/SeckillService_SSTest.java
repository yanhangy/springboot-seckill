...
public class SeckillService_SSTest extends SeckillService_SSTest_scaffolding {
  ...
  public void test_getGoodsOver_0()  throws Throwable  {
      //caseID:292e527c85f8d4896a94e8138a847cd6
      ...
      Object object0 = PrivateAccess.callMethod((Class<SeckillService>) SeckillService.class, seckillService0, "getGoodsOver", (Object) 2694L, (Class<?>) long.class);
      assertEquals(false, object0);
  }
  @Test(timeout = 4000)
  public void test_setGoodsOver_1()  throws Throwable  {
      //caseID:c85cbe1df16f087233dea8bd112c2057
      SeckillService seckillService0 = new SeckillService();
  ...
  public void test_getSeckillResult_2()  throws Throwable  {
      //caseID:47f215239b8ba3351a53dbc070ce5829
      SeckillService seckillService0 = new SeckillService();
      ...
      long long1 = seckillService0.getSeckillResult(1756L, 1L);
      assertEquals(1741L, long1);
  }
  @Test(timeout = 4000)
  public void test_seckill_3()  throws Throwable  {
      //caseID:e3a777b6d0a0b36f9be88276b92aa678
      SeckillService seckillService0 = new SeckillService();
      ...
      doReturn("com.jesper.seckill.service.SeckillService").when(orderInfo0).toString();
      OrderService orderService0 = mock(OrderService.class, withSettings().defaultAnswer(new ViolatedAssumptionAnswer()).stubOnly());
