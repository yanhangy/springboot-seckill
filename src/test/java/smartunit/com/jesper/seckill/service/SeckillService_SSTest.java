...
public class SeckillService_SSTest extends SeckillService_SSTest_scaffolding {
  ...
  public void test_getGoodsOver_0()  throws Throwable  {
      //caseID:ede18a4b7307612aeec5c341f2e77f97
      ...
      Object object0 = PrivateAccess.callMethod((Class<SeckillService>) SeckillService.class, seckillService0, "getGoodsOver", (Object) 1749L, (Class<?>) long.class);
      assertEquals(true, object0);
  }
  @Test(timeout = 4000)
  public void test_setGoodsOver_1()  throws Throwable  {
      //caseID:533804e34fee39a57156fc9853030325
      SeckillService seckillService0 = new SeckillService();

      //prepare data for redisService0
      Boolean boolean0 = Boolean.valueOf("factory may not be null");
      RedisService redisService0 = mock(RedisService.class, withSettings().defaultAnswer(new ViolatedAssumptionAnswer()).stubOnly());
  ...
  public void test_getSeckillResult_2()  throws Throwable  {
      //caseID:1e360738ef317f478fdde1ec83c4273b
      SeckillService seckillService0 = new SeckillService();
      ...
      long long1 = seckillService0.getSeckillResult((-1L), 0L);
      assertEquals(235L, long1);
  }
  @Test(timeout = 4000)
  public void test_seckill_3()  throws Throwable  {
      //caseID:b8d216f869b433c1e02cb19b85f8a1ee
      SeckillService seckillService0 = new SeckillService();
      ...
      doReturn("1.0").when(orderInfo0).toString();
      OrderService orderService0 = mock(OrderService.class, withSettings().defaultAnswer(new ViolatedAssumptionAnswer()).stubOnly());
