...
public class OrderService_SSTest extends OrderService_SSTest_scaffolding {
  ...
  public void test_getOrderByUserIdGoodsId_0()  throws Throwable  {
      //caseID:0eacd96782353fe7a37dc3e2fa4f054e
      ...
      SeckillOrder seckillOrder1 = orderService0.getOrderByUserIdGoodsId((-2547L), 323L);
      assertNull(seckillOrder1.getUserId());
  }
  @Test(timeout = 4000)
  public void test_getOrderById_1()  throws Throwable  {
      //caseID:9c9944711572bb89db3f6ffada065b16
      OrderService orderService0 = new OrderService();
      ...
      OrderInfo orderInfo1 = orderService0.getOrderById(2740L);
      assertNull(orderInfo1.getGoodsName());
  }
  @Test(timeout = 4000)
  public void test_createOrder_2()  throws Throwable  {
      //caseID:ac7772035105543cf8e76d9510c4b8a0
      OrderService orderService0 = new OrderService();
      ...
      doReturn("9").when(goodsVo0).getGoodsName();
