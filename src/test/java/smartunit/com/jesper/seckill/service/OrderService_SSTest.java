...
public class OrderService_SSTest extends OrderService_SSTest_scaffolding {
  ...
  public void test_getOrderByUserIdGoodsId_0()  throws Throwable  {
      //caseID:81310aa73c1a2227c80c0236640ce1cf
      ...
      SeckillOrder seckillOrder1 = orderService0.getOrderByUserIdGoodsId((-52L), 0L);
      assertNull(seckillOrder1.getUserId());
  }
  @Test(timeout = 4000)
  public void test_getOrderById_1()  throws Throwable  {
      //caseID:a345a1a54bd6efec110968ac7104d198
      OrderService orderService0 = new OrderService();
      ...
      OrderInfo orderInfo1 = orderService0.getOrderById((-1L));
      assertNull(orderInfo1.getDeliveryAddrId());
  }
  @Test(timeout = 4000)
  public void test_createOrder_2()  throws Throwable  {
      //caseID:dd964068055239d42743bc6b269f2f59
      OrderService orderService0 = new OrderService();

      //prepare data for orderMapper0
      OrderMapper orderMapper0 = mock(OrderMapper.class, withSettings().defaultAnswer(new ViolatedAssumptionAnswer()).stubOnly());
      doReturn((-980L)).when(orderMapper0).insert(any(com.jesper.seckill.bean.OrderInfo.class));
      doReturn(1813).when(orderMapper0).insertSeckillOrder(any(com.jesper.seckill.bean.SeckillOrder.class));
